...
% Dati dello Studente
\newcommand{\nomeStudente}{Enrico}
\newcommand{\cognomeStudente}{Cotti Cottini}
\newcommand{\matricolaStudente}{2077993}
\newcommand{\emailStudente}{enrico.cottini@studenti.unipd.it}
\newcommand{\telStudente}{+ 39 345 01 76 450}

% Dati del Tutor Aziendale
\newcommand{\nomeTutorAziendale}{Andrea}
\newcommand{\cognomeTutorAziendale}{Paris}
\newcommand{\emailTutorAziendale}{andrea.paris@nuvemsrl.it}
\newcommand{\telTutorAziendale}{+ 39 339 89 79 032}
\newcommand{\ruoloTutorAziendale}{Software Engineer}

% Dati dell'Azienda
\newcommand{\ragioneSocAzienda}{Nuvem Srl}
\newcommand{\indirizzoAzienda}{Via Valle Roncaglia 16, 25050 Pian Camuno (BS)}
\newcommand{\sitoAzienda}{https://nuvemsrl.it/}
\newcommand{\emailAzienda}{info@nuvemsrl.it}
\newcommand{\partitaIVAAzienda}{P.IVA 04482250984}
